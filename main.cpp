...

    {
        ...
        else if ((source == 1 && destination == 4) || (source == 4 && destination == 1))
        {
            ...
            cout << "Airlines\tDeparture\tArrival\t\tPrice\n"
                 << endl;
            ;
            cout << "\nAir India(1)\t08:00\t\t11:05\t\tRs.5000\n";
            cout << "\nndiGo(2)\t14:00\t\t17:05\t\tRs.5500\n";
            cout << "\npiceJet(3)t18:00\t\t21:05\t\tRs.6000\n";
        }
        ...
        else if ((source == 2 && destination == 3) || (source == 3 && destination == 2))
        {
            ...
            cout << "Airlines\tDeparture\tArrival\t\tPrice\n"
                 << endl;
            cout << "\nir India(1)\t08:00\t\t11:05\t\tRs.5000\n";
            cout << "\nIndiGo(2)\t14:00\t\t17:05\t\tRs.5500\n";
            cout << "\nSpiceJet(3)\t18:00\t\t21:05\t\tRs.6000\n";
        }
